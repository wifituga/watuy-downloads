...
La página muestra únicamente la versión estable más reciente. Los instaladores se publican con su hash SHA-256 y el updater de Tauri requiere una firma válida.
